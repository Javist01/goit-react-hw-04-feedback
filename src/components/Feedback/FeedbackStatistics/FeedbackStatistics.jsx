...
const Statistics = ({ good, bad, neutral, total, positivePercentage }) => {
    return (
        <StatisticList className="Statistic-list">
            ...
            <StatisticElement className="key-neutral">Neutral: {neutral}</StatisticElement>
            ...
            <StatisticElement className="key-positive">Positive feedback: {positivePercentage} % </StatisticElement>
        </StatisticList>
    );
};
